...
<head>
    ...
    <title>Metin Oluşturma ve Yazdırma</title>
    <style>
        body {
...
<body>
    ...
    <form id="textForm">
        ...
        <input type="number" id="questionCount" name="questionCount" required><br><br>

        <button type="submit">Metni Oluştur</button>
    </form>
    ...
    <script>
        ...
        document.getElementById("printButton").addEventListener("click", function () {
            ...
            // Yazdırma penceresine stil ekleme
            printWindow.document.write('<html><head><title>Yazdır</title>');
            printWindow.document.write('<style>');
            printWindow.document.write('body { font-family: Arial, sans-serif; font-size: 16px; line-height: 1.6; margin: 0; padding: 0; }');
            printWindow.document.write('div { margin: 20px; }');
            printWindow.document.write('h1, h2 { text-align: center; font-weight: bold; }');
            printWindow.document.write('p { text-indent: 20px; margin-bottom: 15px; }');
            // Sayfa numarası, tarih ve saat gibi üst bilgi ve alt bilgi için stil ekleyelim
            printWindow.document.write('@page { size: auto; margin: 0; }');
            printWindow.document.write('header, footer { display: none; }');
